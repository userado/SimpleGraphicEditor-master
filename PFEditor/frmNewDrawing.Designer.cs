namespace PFEditor
{
    partial class frmNewDrawing
    {
        ...
        /// </summary>
        /// <param name="disposing">връща истина при използване; иначе връща не-истина.</param>
        ...
        /// <summary>
        /// метод за подръжката на дизайнера - не променяй съдържанието от този метод
        /// </summary>
